#!/bin/bash
# Enhanced seed data with notes column for destination testing
...
-- Customers table (destination - includes notes column for schema difference testing)
...
-- Insert test data with notes for destination
INSERT INTO customers (id, email, first_name, last_name, phone, notes) VALUES
(1, 'alice.johnson@example.com', 'Alice', 'Johnson', '555-001-1234', 'VIP customer - special handling required'),
(2, 'bob.smith@example.com', 'Bob', 'Smith', '555-002-5678', 'Frequent buyer'),
(3, 'charlie.brown@example.com', 'Charlie', 'Brown', '555-003-9012', NULL),
(4, 'diana.prince@example.com', 'Diana', 'Prince', '555-004-3456', 'Corporate account'),
(5, 'edward.nigma@example.com', 'Edward', 'Nigma', '555-005-7890', 'Returns often');
