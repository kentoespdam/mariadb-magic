...
- [ ] T1#1 `mariadb-magic-7x4.1` — Pindahkan SSE endpoint ke `/api/sse/{id}` _(no blocker)_
- [ ] T1#2 `mariadb-magic-7x4.2` — Drift surfaces via Preflight endpoint _(no blocker)_
...
- [ ] T1#16 `mariadb-magic-7x4.16` — Vitest setup _(no blocker)_
- [ ] T1#18 `mariadb-magic-7x4.18` — Makefile + embed-check _(no blocker)_
- [ ] T1#19 `mariadb-magic-7x4.19` — config loader + godotenv **[P1 kritis]** _(no blocker)_
...
- [ ] T1#17 `mariadb-magic-7x4.17` — `lib/apiClient` + services **[P1 kritis]** _(← T1#9, T1#4)_
...
- [ ] T1#22 `mariadb-magic-7x4.22` — Prometheus metrics + system info _(← T1#9, T1#17, T1#19)_
