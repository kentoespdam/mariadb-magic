...
-- Insert minimal test data (same as source but with notes column)
INSERT INTO customers (id, email, first_name, last_name, phone, notes) VALUES
(1, 'test1@example.com', 'Test', 'Customer', '123-456-7890', NULL),
(2, 'test2@example.com', 'Test2', 'Customer2', '098-765-4321', NULL);
