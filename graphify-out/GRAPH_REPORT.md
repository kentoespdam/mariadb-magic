...
## Corpus Check
- 66 files · ~51,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 493 nodes · 796 edges · 29 communities detected
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.8)
...
Cohesion: 0.16
Nodes (12): ConnectionHandler, getID(), CreateConnectionRequest, getProfileID(), ProfilesHandler, KeystoreProvider, NewPassphraseProvider(), TestPassphraseEncryptDecrypt() (+4 more)
...
Cohesion: 0.07
Nodes (12): getSessionID(), NewSessionsHandler(), SessionsHandler, detectWSL(), OpenURL(), NewSyncLogsRepo(), NewSyncSessionsRepo(), SyncLog (+4 more)
...
Cohesion: 0.1
Nodes (17): Column, ForeignKey, NewIntrospector(), Introspector, Close(), Schema, TableSchema, checkDestDrift() (+9 more)
...
Cohesion: 0.33
Nodes (4): Params, NewPassphraseKeyProvider(), PassphraseProvider, decryptPassword()
...
- **Thin community `Community 18`** (5 nodes): `app_settings.go`, `NewAppSettingsRepo()`, `AppSettingsRepo`, `.Get()`, `.Set()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (4 nodes): `useProfileBuilder()`, `ProfileBuilderPage()`, `page.tsx`, `useProfileBuilder.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (3 nodes): `app.go`, `AppSettings`, `Connection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (2 nodes): `Internal SQLite schema (4 tables)`, `Internal Data Schema (PRD §6)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (2 nodes): `File size cap rule (≤100/120 lines)`, `Definition of Done checklist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `Smart Mapping feature`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `Out of Scope V1 (PRD §8)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Close()` connect `Community 6` to `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 3` to `Community 2`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 18`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `collectAndSync()` connect `Community 5` to `Community 2`, `Community 6`?**
