...
-- Customers table (destination - includes notes column)
CREATE TABLE customers (
    ...
    phone VARCHAR(20),
    notes TEXT, -- This column exists only in destination
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);

-- Orders table (same as source)
CREATE TABLE orders (
    id INT PRIMARY KEY AUTO_INCREMENT,
...
-- Order items table (same as source)
...
-- Insert same customer data as source but with NULL notes
INSERT INTO customers (id, email, first_name, last_name, phone, notes) VALUES
(1, 'john.doe@example.com', 'John', 'Doe', '+1-555-0101', NULL),
(2, 'jane.smith@example.com', 'Jane', 'Smith', '+1-555-0102', NULL),
(3, 'bob.johnson@example.com', 'Bob', 'Johnson', '+1-555-0103', NULL),
(4, 'alice.wilson@example.com', 'Alice', 'Wilson', '+1-555-0104', NULL),
(5, 'charlie.brown@example.com', 'Charlie', 'Brown', '+1-555-0105', NULL);

-- Generate remaining customers programmatically with NULL notes
SET @counter = 6;
...
-- Generate remaining orders programmatically (same as source)
SET @order_counter = 6;
SET @customer_id = 1;
...
-- Insert same order items as source
...
-- Generate remaining order items programmatically (same as source)
SET @item_counter = 6;
SET @order_id = 1;
...
-- Verify data counts and show schema difference
