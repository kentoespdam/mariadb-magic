...
## Corpus Check
- 51 files · ~47,662 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 403 nodes · 628 edges · 28 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.8)
...
Cohesion: 0.11
Nodes (9): Column, ForeignKey, NewIntrospector(), Introspector, Close(), Schema, TableSchema, scanMappingProfileRows() (+1 more)
...
## Knowledge Gaps
- **97 isolated node(s):** `TableWithRole`, `Params`, `KeyMode`, `KeyProvider`, `ProviderFactory` (+92 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 18`** (4 nodes): `useProfileBuilder()`, `ProfileBuilderPage()`, `page.tsx`, `useProfileBuilder.ts`
...
- **Why does `run()` connect `Community 1` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 12`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `Close()` connect `Community 4` to `Community 1`, `Community 3`, `Community 7`, `Community 8`, `Community 11`?**
...
- **Are the 13 inferred relationships involving `Close()` (e.g. with `.List()` and `.List()`) actually correct?**
  _`Close()` has 13 INFERRED edges - model-reasoned connections that need verification._
