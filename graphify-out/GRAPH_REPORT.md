...
## Corpus Check
- 193 files · ~168,535 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 753 nodes · 1223 edges · 36 communities detected
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 537 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (17): detectWSL(), OpenURL(), Retention, Handler(), stringPtr(), SyncSessionsRepo, ProgressPublisher, Runner (+9 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (23): PassphraseProvider, NewBootstrapper(), Bootstrapper, cleanupZombieSessions(), EnsureDB(), HasDB(), Heal(), quarantineAndRebuild() (+15 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (19): Column, ForeignKey, NewIntrospector(), Introspector, Close(), Schema, TableSchema, checkDestDrift() (+11 more)
...
Cohesion: 0.19
Nodes (8): stubKey, KeystoreProvider, Params, NewPassphraseKeyProvider(), NewPassphraseProvider(), TestPassphraseEncryptDecrypt(), TestPassphraseRekey(), TestPassphraseWrongKey()
...
- **Thin community `Community 25`** (6 nodes): `TestDecryptStoredCredential()`, `mockKeyProvider`, `.Decrypt()`, `.Encrypt()`, `.Rekey()`, `decrypt_test.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (6 nodes): `useSseSession()`, `SessionDetailContent()`, `StatusIconSmall()`, `TableBreakdown()`, `page.tsx`, `useSseSession.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (4 nodes): `app_settings.go`, `NewAppSettingsRepo()`, `AppSettingsRepo`, `.Get()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 36`** (3 nodes): `ErrorBody`, `ErrorEnvelope`, `errors.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (3 nodes): `ConnectionResponse`, `CreateConnectionRequest`, `connections_types.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (3 nodes): `BatchCreateRequest`, `BatchCreateResponse`, `connections_batch.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (3 nodes): `app.go`, `AppSettings`, `Connection`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (3 nodes): `EditProfileContent()`, `EditProfilePage()`, `page.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `run()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 16`, `Community 25`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `Close()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 13`?**
